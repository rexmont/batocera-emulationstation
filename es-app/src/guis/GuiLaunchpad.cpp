...
GuiLaunchpad::GuiLaunchpad(Window* window)
	: GuiComponent(window), mGrid(window, Vector2i(1, 4)), mBackground(window, ":/frame.png")
{
	...
	mTitle = std::make_shared<TextComponent>(mWindow, _("LAUNCHPAD"), theme->Title.font, theme->Title.color, ALIGN_CENTER);
	mSubtitle = std::make_shared<TextComponent>(mWindow, _("YOUR SAVESTATES LISTED HERE"), theme->TextSmall.font, theme->TextSmall.color, ALIGN_CENTER);
...
void GuiLaunchpad::update(int deltaTime)
{
...
void GuiLaunchpad::onSizeChanged()
{
...
void GuiLaunchpad::centerWindow()
{
...
void GuiLaunchpad::loadList(bool updatePackageList, bool restoreIndex)
{
...
std::vector<PacmanPackage> GuiLaunchpad::queryPackages()
{
...
void GuiLaunchpad::loadPackagesAsync(bool updatePackageList, bool refreshOnly)
{
...
void GuiLaunchpad::processPackage(PacmanPackage package)
{	
...
bool GuiLaunchpad::input(InputConfig* config, Input input)
{
...
std::vector<HelpPrompt> GuiLaunchpad::getHelpPrompts()
{
...
GuiLaunchpadSaveEntry::GuiLaunchpadSaveEntry(Window* window, PacmanPackage& entry, bool withPreviewImage) :
...
void GuiLaunchpadSaveEntry::setColor(unsigned int color)
{
...
void GuiLaunchpadSaveEntry::update(int deltaTime)
{
